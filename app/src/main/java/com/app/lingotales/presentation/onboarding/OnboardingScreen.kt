...
import com.app.lingotales.presentation.onboarding.OnboardingViewModel
...
fun OnboardingPagerItem(page: OnboardingPage) {
    Column(
        ...
        Image(
            ...
            modifier = Modifier
                .height(300.dp) // Görseli büyüttük
                .padding(bottom = 32.dp)
        )
        Text(
            text = page.title,
            style = MaterialTheme.typography.displaySmall, // Başlık daha büyük
            color = Color.Black,
            modifier = Modifier.padding(bottom = 16.dp)
        )
        Text(
            text = page.description,
            style = MaterialTheme.typography.titleMedium, // Açıklama da büyüdü
